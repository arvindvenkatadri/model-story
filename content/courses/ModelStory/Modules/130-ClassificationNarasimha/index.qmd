---
title: ML-Classification with Narasimha
subtitle: ""
date: "2021-08-09"
date-modified: today
image: featured.jpg
fig-alt: Photo of [Yoga Narasimha at Hampi by Ruben Swieringa](https://www.flickr.com/photos/rubenswieringa/5413762847) on flickr
order: 130
...
## [Narasimha Agaccha](https://youtu.be/e0ENcwgf7-o)
...
Hovering over Narasimha's head are 7 cobras."]{.f5 .f4-m .f3-l .lh-copy .measure .mt0}

[ --- From Hampi]{.f6 .ttu .tracked .fs-normal}

:::
::::

Where does Narasimha show up? Why does he look like he does? What are the attributes and characteristics that would help us describe him to someone from another continent? To a Martian? 

## {{< iconify mingcute question-fill >}}A Childhood Game
...
## {{< iconify mdi head-question-outline >}} {{< iconify carbon data-table >}}20Q Game as a Play with Data...
...
Can you imagine how the **20 Questions** Game can be shown as a **tree**? Yes, upside-down perhaps, but nevertheless a tree!
...
This forms the basic intuition for a Machine Learning Algorithm called a **Decision Tree**. Note that we being human, our tree is plotted **inverted**: trunk on top and the leaves below. [Only God can make a tree.](https://www.poetryfoundation.org/poetrymagazine/poems/12744/trees)

```{r}
#| label: fig-penguins-decision-tree
#| fig-cap: Penguins Decision Tree!
#| echo: false
#| fig-align: center
#| out-width: "100%"
#| out-height: "100%"
...
[Orange Data Mining](https://orangedatamining.com/) is very intuitive, no-code, point-and-click, Photoshop-like tool for Data Analysis, Visualization, and Machine Learning, that was created at the University of Ljubljana in Slovenia. It is a very good tool for **teaching** and **learning** Data Science, and is used in many universities around the world.

A quick intro to Orange is on my [No Code Data Viz](https://nocodedataviz.netlify.app/content/courses/nocodedataviz/modules/05-introductiontoorange/) website!
...
## {{< iconify game-icons circle-forest >}} How Many Trees do we Need? Enter the Random Forest!
...
A forest of such trees is called [`r emoji::emoji("film")` ~~**the Wild Wood**~~](https://youtu.be/zE0uAfAuZ08) **a Random Forest** ! 

## {{< iconify fluent-emoji-high-contrast game-die >}}{{< iconify game-icons circle-forest >}}An Introduction to Random Forests
...
{{< html https://waternova.github.io/random-forest-viz/ >}}
...
- [`r emoji::emoji("music")` Do it **Again**](https://youtu.be/jmdiKePVUy8) when presented with fresh data

Not bad, is it, as a metaphor for Random Forests? Can <u>[`r emoji::emoji("page_with_curl")`More is Different](Strogatz_et_al_2022_More_is_different.pdf)</u> be true here too?

## Random Forest Classification in Orange

Let us see how to create a Random Forests ML model in Orange:

::: {fig-random-forests-orange}
<center>
{{< video https://www.youtube-nocookie.com/embed/gSQsFIMcA8A width="640" height="400" align="center" title="" >}}
</center>
Random Forests in Orange
:::
...
[**Cleveland Heart Patient Data CSV**](processed.cleveland.data.csv)

We will download this data and use it with this Orange Workflow file. [Random Forests Workflow File](random_forest.ows)
...
4. R package *data.tree* sample applications, Christoph Glur, 2020-07-31. <https://cran.r-project.org/web/packages/data.tree/vignettes/applications.html>
