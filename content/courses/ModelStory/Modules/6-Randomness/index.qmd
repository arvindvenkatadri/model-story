...
If we assume that an H means people <u>[**get into their car and
drive**](https://youtu.be/w9NbXDXvr8M)</u>, what can we say of many many
...
us an aggregate <u>[**Poisson
distribution**](https://math.oxford.emory.edu/site/math117/connectingPoissonAndBinomial/)</u>
...
6.  Or the last person to bat or bowl, or whatever was the cool thing in
    the game...
7.  Or did you do that "bat numbers" thing?
8.  Why did you trust your friends? ;-D
9.  What strategy did you use when playing "Rock, Paper, Scissors"? Were
...
So can we use **Randomness** in Design? With *intent*? And is
<u>[this](https://www.jacksonpollock.org)</u> the use of **randomness**
in Art?
...
![Hedy
Lamarr](Hedy-Lamarr-and-the-Frequency-Hopping-Spread-Spectrum.jpg)
...
-   What does that even mean, to <u>["generate
    randomness"](https://www.random.org/coins/)</u>?
...
8.  Mozart Dice Game: Generate Mozart-like tunes by throwing dice:
    <u><https://vician.net/mozart/></u>
9.  Theodore Sturgeon. (September 1957). *The Pod in the Barrier.*
    Galaxy Science Fiction.
    <u><https://archive.org/details/galaxymagazine-1957-09/page/n9/mode/2up?view=theater></u>
