...
+====================================+================================+
| To be, or not to be: that is the   | The first six words of the     |
| question:                          | soliloquy establish a balance. |
|                                    | There is a direct opposition – |
|                                    | to be, or not to be. Hamlet is |
|                                    | thinking about life and death  |
|                                    | and pondering a state of being |
|                                    | versus a state of not being –  |
|                                    | being alive and being dead.    |
+------------------------------------+--------------------------------+
| Whether ’tis nobler in the mind to | The balance continues with a   |
| suffer\                            | consideration of the way one   |
| *The slings and arrows of          | deals with life and death.     |
| outrageous fortune*,\              | Life is a lack of power: the   |
| Or to take arms against a *sea of  | living are at the mercy of     |
| troubles*,\                        | *the blows of outrageous       |
...
| No more; and by a sleep to say we  | against the things he lists    |
| end\                               | among those blows is to end    |
| The heart-ache and the *thousand   | one’s life.                    |
| natural shocks*\                   |                                |
...
|                                    | empowering: killing oneself is |
|                                    | a way of taking action, taking |
|                                    | up arms, opposing and          |
...
| To sleep: perchance to dream: ay,  | devoutly to be wished, a       |
| there’s the rub;\                  | consummation – a perfect       |
| For in that sleep of death what    | closure. It’s nothing more     |
| dreams may come\                   | than a sleep.                  |
| When we have shuffled off this     |                                |
| mortal coil,\                      | But there’s a catch, which     |
| Must give us pause: there’s the    | Hamlet calls a rub. A ‘rub’ is |
| respect\                           | a bowls term meaning an        |
| That makes calamity of so long     | obstacle on the bowls lawn     |
| life;\                             | that diverts the bowl, so the  |
| For who would bear the *whips and  | fear of the life hereafter is  |
| scorns of time*,\                  | the obstacle that makes us     |
| The oppressor’s wrong, the proud   | pause and perhaps change the   |
| man’s contumely,\                  | direction of our thinking.     |
| The pangs of despised love, the    |                                |
| law’s delay,\                      | We don’t control our dreams so |
| The insolence of office and the    | what dreams may come in that   |
| spurns\                            | sleep in which we have         |
| That patient merit of the unworthy | shuffled off all the fuss and  |
| takes,\                            | bother of life? He uses the    |
| When he himself might his quietus  | term ‘[mortal                  |
| make\                              | coil](h%20%20t%20t%20ps%20:    |
| With a bare bodkin? who would      | %20//n%20os%20w%20eat%20s%2%20 |
| fardels bear,\                     | 0hakes%20peare%20.co%20%2%20%2 |
| To *grunt and sweat under a weary  | 00%20m%20/%20q%20u%20o%20%20t% |
| life*,                             | 20%20es/famous/mortal-coil/),’ |
|                                    | which is an Elizabethan word   |
|                                    | for a big fuss. With that      |
|                                    | thought, Hamlet stops to       |
|                                    | reconsider. What will happen   |
|                                    | when we have discarded all the |
|                                    | hustle and bustle of life?     |
+------------------------------------+--------------------------------+
| But that the *dread of something*  | *The problem with the          |
| after death,\                      | proposition* is that the sleep |
| The *undiscover’d country* from    | of death is unknown and could  |
| whose bourn\                       | be worse than life.            |
| No traveller returns, *puzzles the |                                |
| will*\                             | Hamlet now lets his            |
| And makes us rather bear those     | imagination wander on the      |
| *ills we have*\                    | subject of the voyages of      |
| Than fly to others that we know    | discovery and the exploratory  |
| not of?                            | expeditions. Dying is like     |
...
|                                    | that land.                     |
+------------------------------------+--------------------------------+
| Thus conscience does make cowards  | But there is more to it than   |
| of us all;\                        | that. It is not just about     |
| And thus the native hue of         | killing himself but also about |
| resolution\                        | the mission he is on – to      |
| Is sicklied o’er with the pale     | avenge his father’s death by   |
| cast of thought,\                  | killing his father’s murderer. |
| And *enterprises of great pith and | Throughout the action of the   |
| moment*\                           | play, he makes excuses for not |
| With this regard their currents    | killing him and turns away     |
| turn awry,\                        | when he has the chance.        |
| And lose *the name of action*.     | ‘Conscience does make cowards  |
|                                    | of us all.’ Convention demands |
| \                                  | that he kill Claudius but      |
|                                    | murder is a sin and that       |
|                                    | conflict is the core of the    |
|                                    | play.                          |
|                                    |                                |
...
|                                    | rise to.                       |
+------------------------------------+--------------------------------+
| –Soft you now! The fair Ophelia!\  | ~~Saraswati Namostute ! Grant  |
| Nymph, in thy orisons\             | me Grace and Knowledge on How  |
| Be all my sins remember’d.         | to Proceed!~~                  |
+------------------------------------+--------------------------------+
...
1. David Spiegelhalter (2019) *The Art of Statistics: Learning from Data*,
